...
function Cart() {
  ...
  if(products.length ===0){
    return <h1 style={{height:"80vh",color:"brown",display:"flex", alignItems:"center", justifyContent:"center", fontSize:"6rem"}}>Your cart is empty</h1>;
  }
  const total = products.reduce((sum:number,p: CartProduct) => sum+p.price * (p.quantity || 1),0);
