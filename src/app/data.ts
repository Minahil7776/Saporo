...
export const burgers: Products = [
  {
    id: 16,
    title: "Bacon Deluxe",
    desc: "Indulge in smoky goodness with a flame-grilled beef patty, topped with crispy bacon, melted cheddar cheese, caramelized onions, and tangy BBQ sauce.",
    img: "/temporary/p2.png",
    price: 29.9,
    options: [
      { title: "Small", additionalPrice: 0 },
  ...
  },
  {
    id: 17,
    title: "Jalapeño Fiesta",
    desc: "A fiery burger featuring a juicy beef patty, jalapeños, pepper jack cheese, and chipotle mayo sauce on a toasted bun.",
    img: "/temporary/p5.png",
    price: 29.9,
    options: [
      { title: "Small", additionalPrice: 0 },
  ...
  },
  {
    id: 18,
    title: "Hawaiian Teriyaki",
    desc: "A tropical twist with a beef patty glazed in teriyaki sauce, grilled pineapple, crispy bacon, and lettuce on a toasted bun.",
    img: "/temporary/p9.png",
    price: 29.9,
    options: [
      { title: "Small", additionalPrice: 0 },
...
export const pastas: Products = [
  {
    id: 19,
    title: "Spicy Arrabbiata",
    desc: "Penne pasta in a spicy tomato sauce with garlic, red chili flakes, and fresh basil for a bold kick.",
    img: "/temporary/p4.png",
    price: 26.9,
    options: [
      { title: "Small", additionalPrice: 0 },
  ...
  },
  {
    id: 20,
    title: "Garlic Parmesan Linguine",
    desc: "Linguine in a creamy Parmesan sauce, infused with garlic and garnished with parsley, peppers, and cherry tomatoes.",
    img: "/temporary/p7.png",
    price: 28.9,
    options: [
      { title: "Small", additionalPrice: 0 },
